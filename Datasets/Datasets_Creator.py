...
TOP_ARTISTS = 100 # Specify how many artist will have the new dataset
NUM_IMAGES_PER_ARTIST = "ALL" # How many pictures for each artists, specifay "ALL" if you want to take all the pictures
...
# Save the dataset
df_top_artists.to_csv(f"TOP{TOP_ARTISTS}_ARTISTS_WITH_{NUM_IMAGES_PER_ARTIST}_PICTURES.csv", index=False)
